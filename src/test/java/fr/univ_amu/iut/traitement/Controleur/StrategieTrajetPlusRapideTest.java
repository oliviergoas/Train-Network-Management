...
/**
 * Created by christophe on 17/11/2017.
 */
public class StrategieTrajetPlusRapideTest {
    /*@Test
    public void appliquerStrategie() throws Exception, GareNonDesservieException, SillonDejaAttribueException {
        ...
        gareParis.addGareDesservie(gareMarseille);
        ...
        StrategieControleur strategieControleur = new StrategieTrajetPlusRapide();
