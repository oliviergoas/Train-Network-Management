...
public class StrategieMinTempsTest {
   /* @Test
    public void appliquer() throws Exception, GareNonDesservieException, SillonDejaAttribueException {
        ...
        Controleur.attribuerSillon(ligne1,LocalTime.of(8,0));
      ...
      System.out.println(Controleur.getSillonsDejaAttribues()+"\n"+"\n");
        ...
        StrategieControleur strategieControleur = new StrategieMinTemps();
