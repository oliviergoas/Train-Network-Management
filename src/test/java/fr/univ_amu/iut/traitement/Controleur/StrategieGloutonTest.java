 ...
 */
public class StrategieGloutonTest {

    @Test
    public void Appliquer_Reserve_Bien_Les_Sillons_Les_Moins_Couteux_Pour_Un_Trajet() throws Exception, GareNonDesservieException {
        ...
        LigneFerroviaire ligne3 = new LigneFerroviaire(gareLille, gareParis);
