...
/**
 * Classe de définition des trains de transport de betails. Celle ci herite de Train.
 */
public class TrainTransportBetails extends Train implements Visitable {
     ...
     */
    private TrainTransportBetails(Builder builder) {
    ...
    public static class Builder {
        ...
        public TrainTransportBetails build() {
            return new TrainTransportBetails(this);
        }
    }
}
